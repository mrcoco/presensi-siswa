...
class Sosial extends Component
{
    ...
    public function insta(){
        ...
        for ($i=0; $i < $limit; $i++) {
            ...
            $image_data  = '<li><img width="75px" plugin="'.$latest_array['thumbnail_src'].'"></li>'; // thumbnail and same sizes
            //$image_data  = '<img plugin="'.$latest_array['display_src'].'">'; actual image and different sizes
...
//            $li = "<li><img width='75px' height='75px' plugin='".$item->imageThumbnailUrl."'></li>";
