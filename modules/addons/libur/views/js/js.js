$(document).ready(function(){
    ...
    var libur_grid = $("#grid-libur").bootgrid({
        ...
        multiSelect: true,
        templates: {
            header:"<div id=\"{{ctx.id}}\" class=\"{{css.header}}\"><div class=\"row\"><div class=\"col-sm-6 actionBar\"><div class=\"{{css.search}}\"></div></div><div class=\"col-sm-6\"><div class=\"{{css.actions}}\"></div> <div class='btn btn-primary' id='create' class='command-add'> <span class=\"fa fa-plus-square-o\"></span> New Libur</div></div></div></div>",
        },
        formatters: {
    ...
    function myForm(status,e) {
        ...
        if(status == 'edit') {
            ...
            $('#mylibur .modal-title').html('Edit libur '+e.data("row-id"));
	 ...
	 $('#keterangan').val(data.keterangan);
            ...
            $('#mylibur .modal-title').html('Create New libur ');
