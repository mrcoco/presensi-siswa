<div class="col-md-12 col-sm-12">
    <div class="box">
        ...
        <div class="box-body collapse in">
            {{ content() }}
        <table id="grid-history" class="table table-condensed table-hover table-striped">
            <thead>
            <tr>
	...
	<th data-column-id="sex" data-sortable="false">Sex</th>
...
<div id="myhistory" class="modal fade modal-wide" tabindex="-1" role="dialog">
